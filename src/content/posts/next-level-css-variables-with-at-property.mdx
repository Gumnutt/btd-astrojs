...
description: "A short explainer of the `@property` CSS At-Rule."
tags: ["CSS"]
author: "Gumnut"
---
...
<Previewer site_url="https://docs.astro.build/en/guides/content-collections/" title="A title for the frame" client:load />
